...
import elis from "../../../assets/images/elis.png";
...
const CountDown = () => {
  const renderer = ({
    ...
    if (completed) {
      return (
        <h1 className="font-[600] text-[40px] w-full md:text-[30px]">
          Summer sales completed
        </h1>
      );
    } else {
      return (
  ...
  const targetDate = new Date("2025-04-05 00:00:00");
  return (
    <div className="w-full bg-[#000000] h-[450px]  flex mb-5 ">
      ...
      <div className="flex-[1] relative  w-full h-full pr-[20px] items-center justify-center hidden lg:flex bg-transparent overflow-hidden">
        <img
          src={elis}
          className="absolute w-[100%] h-[100%]  top-0 left-0 translate-y-[0%]  -z-0 translate-x-[10%]  "
        />
